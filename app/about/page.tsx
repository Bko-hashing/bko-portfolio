  ...
  return (
    <div className="min-h-screen bg-blue-100">
      ...
      <section className="flex flex-col items-center justify-center min-h-screen relative">
        <h1 className="text-4xl font-bold mb-8 items-center justify-center ">
          About Me!
        </h1>
        <div
          ref={typewriterRef}
          className="text-lg text-black mb-8 text-center min-h-[18rem]"
        />
        <button
        ...
        >
          <span className="text-blue-700 font-semibold mb-1 group-hover:underline">
            Learn more
          </span>
          <svg
            className="w-8 h-8 animate-bounce text-blue-700"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
            viewBox="0 0 24 24"
        ...
        <section className="w-full flex flex-col md:flex-row items-center justify-center mb-16">
          <div className="md:w-2/3 w-full md:pr-8">
            ...
            <p className="text-lg text-black mb-4">
              ...
              languages. These interests inspired me to create projects like a
              web application for helping traders/investers with key technical,
              seasonal, dividend, and growth data and collaborate in a project
              with a fellow friend/SWE in helping others financially. Harvesting
              the power of technology to transform individual hobbies into
              practical solutions is what fulfills me in life.
            </p>
          ...
          <div className="md:w-1/3 w-full flex justify-center mt-8 md:mt-0">
            <Image
              src="https://raw.githubusercontent.com/Bko-hashing/bko-portfolio/refs/heads/main/public/personalheadpic.png"
              alt="Bernard Ko"
              width={350}
              height={350}
        ...
        <section className="w-full max-w-6xl mx-auto mb-16">
          ...
          <div className="space-y-8 mt-8">
            ...
            <div className="flex flex-col md:flex-row items-center bg-white rounded-lg shadow p-6">
              <div className="md:w-1/5 w-full flex justify-center mb-4 md:mb-0">
                <Image
                  src="https://raw.githubusercontent.com/Bko-hashing/bko-portfolio/refs/heads/main/public/ccny.png"
                  alt="CCNY"
                  width={120}
                  height={120}
                  className="rounded-full"
              ...
              <div className="md:w-4/5 w-full md:pl-8">
                ...
                <div className="text-lg mb-1">
                  Bachelors of Engineering in Electrical Engineering with Minor
                  in Mathematics
                </div>
                <div className="text-gray-600 mb-1">
                ...
                <ul className="list-disc ml-8">
                  ...
                  <li>
                    Data and Computer Communication & Digital Computer Systems
                  </li>
        ...
        <section className="w-full max-w-6xl mx-auto mb-16">
          ...
          <div className="space-y-8 mt-8">
            ...
            <div className="flex flex-col md:flex-row items-center bg-white rounded-lg shadow p-6">
              <div className="md:w-1/5 w-full flex justify-center mb-4 md:mb-0">
                <Image
                  src="https://raw.githubusercontent.com/Bko-hashing/bko-portfolio/refs/heads/main/public/hbklogo.png"
                  alt="HBK Engineering"
                  width={240}
                  height={240}
                  className="rounded-full"
            ...
            <div className="flex flex-col md:flex-row items-center bg-white rounded-lg shadow p-6">
              <div className="md:w-1/5 w-full flex justify-center mb-4 md:mb-0">
                <Image
                  src="https://raw.githubusercontent.com/Bko-hashing/bko-portfolio/refs/heads/main/public/nypalogo.jpg"
            ...
            <div className="flex flex-col md:flex-row items-center bg-white rounded-lg shadow p-6">
              ...
              <div className="md:w-4/5 w-full md:pl-8">
                ...
                <ul className="list-disc ml-8">
                  <li>
                    Collaborated on a research project focusing on radar and
                    optical detection of UAVs, specifically bird-type drones.
                  </li>
                  <li>
                    Deployed a laser generator emitting both in 380 nm to 1mm
                    spectra to illuminate airborne targets.
                  </li>
                  <li>
                    Captured scattered radiation using a photodetector,
                    channeling the data to an oscilloscope for signal
                    generation.
                  </li>
                  <li>
                    Processed and analyzed time domain signals in MATLAB to
                    extract specific frequencies to differentiate bird type
                    drones from biological birds.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="space-y-8 mt-8">
            ...
            <div className="flex flex-col md:flex-row items-center bg-white rounded-lg shadow p-6">
              <div className="md:w-1/5 w-full flex justify-center mb-4 md:mb-0">
                <Image
                src = "./fe.png"
                  // src="https://raw.githubusercontent.com/Bko-hashing/bko-portfolio/main/public/fe.png"
                  alt="FE Logo"
                  width={120}
                  height={120}
                  className="rounded"
              ...
              <div className="md:w-4/5 w-full md:pl-8">
                ...
                <div className="text-lg mb-1 text-gray-700">
                  NCEES ID:{" "}
                  <span className="text-black">22-977-51</span>
                </div>
                <div className="text-gray-600 mb-2">Active</div>
                <a
                  href="https://account.ncees.org/rn/2297751-1539079-1b22958"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-600 font-semibold underline hover:text-blue-800"
                >
